...
|---|---|---|---|---|---|---|---|
| TD-001 | `zkp_registry` | Replace simulated ZKP verification in `verify_zkp_internal` with actual cryptographic verification. | Security | High | High | Resolved | Q3 2024 |
